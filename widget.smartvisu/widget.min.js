...
0;a.shadowOffsetY=0;a.shadowBlur=0;a.fillStyle="#555";a.arc(139,139,138,0,2*Math.PI,!1);a.fill();for(var g,k=0;k<=d;k++){var l=e+k*c,m=1,n=k*h;for(g=b;100>=g;g+=b)a.beginPath(),a.fillStyle=fx.hsv2rgb(n,100,g),a.arc(139,139,m*f+f+1,l,l+c+.01,!1),a.arc(139,139,m*f,l+c+.01,l,!0),a.fill(),m+=1;for(g=100-b;g>=b;g-=b)a.beginPath(),a.fillStyle=fx.hsv2rgb(n,g,100),a.arc(139,139,m*f+f+1,l,l+c+.01,!1),a.arc(139,139,m*f,l+c+.01,l,!0),a.fill(),m+=1}k-=1;l=e+k*c;m=1;n=k*h;for(g=b;100>=g;g+=b/2)a.beginPath(),a.fillStyle=
fx.hsv2rgb(n,0,g),a.arc(139,139,m*f+f+1,l,l+2*c+.01,!1),a.arc(139,139,m*f,l+2*c+.01,l,!0),a.fill(),m+=1;a.beginPath();a.fillStyle="rgb(0,0,0)";a.arc(139,139,f+1,0,2*Math.PI,!1);a.fill()}},click:function(d){var a=this.id.substr(0,this.id.length-5),b=$(this)[0].getContext("2d"),c=$(this).offset(),e=Math.round(d.pageX-c.left);d=Math.round(d.pageY-c.top);b=b.getImageData(e,d,1,1).data;e=$("#"+a).attr("data-max");d=$("#"+a).attr("data-item").explode();io.write(d[0],Math.round(b[0]/255*e));io.write(d[1],
...
$(document).delegate('span[data-widget="basic.shifter"]',{update:function(d,a){var b=Math.min(10*(a[0]/$(this).attr("data-max")*10+.49).toFixed(0),100);0<b&&0!=a[1]?$("#"+this.id+" img").attr("src",$(this).attr("data-pic-on").replace("00",b)):0<b&&"_00.png"==$(this).attr("data-pic-off").substr(-7)?$("#"+this.id+" img").attr("src",$(this).attr("data-pic-off").replace("00",b)):$("#"+this.id+" img").attr("src",$(this).attr("data-pic-off"))},click:function(d){d=$(this).attr("data-item").explode();d[1]&&
